(function(){
  ...
  function totalChupitos(){
    let total = 0;
    Object.values(COUNTS).forEach(v => { total += (Number(v) || 0); });
    return total;
  }
  ...
  function updateHeaderStats(){
    ...
    const totalChupitosVal = totalChupitos();
    ...
    els.statTotalChupitos.textContent = totalChupitosVal.toLocaleString("es-ES");
